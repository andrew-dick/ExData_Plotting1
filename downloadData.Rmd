...
```{r}
download.file(url="https://d396qusza40orc.cloudfront.net/exdata%2Fdata%2Fhousehold_power_consumption.zip", destfile="../rawdata/ElectricPowerConsumption.zip", method="curl")
